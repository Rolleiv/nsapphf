...
export default {
  ...
  methods: {
    ...
    BildeOpplasting (row) {
      this.$router.push({ name: 'Bildeopplasting', params: { ordretype: 'PROD', ordrenr: row.ns800Produksjonsordrehode_Lotnr, ordrenavn: row.ns010Produksjonsavdeling_Beskrivelse } })
    },
    Visbilder (row) {
      this.$router.push({ name: 'Visbilder', params: { ordretype: 'PROD', ordrenr: row.ns800Produksjonsordrehode_Lotnr, ordrenavn: row.ns010Produksjonsavdeling_Beskrivelse } })
    }
  },
  mounted () {
    this.fetchOrders()
